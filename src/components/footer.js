  ...
  return (
    <div className="bg-dark py-3">
      <div className="d-flex flex-column gap-3 justify-content-center">
        <div className="my-3">
          <a class="navbar-brand col-1 fs-3" href="#">
            <span className=" fw-bold text-danger">Port</span>
            <span className=" fw-bold text-white">folio.</span>
          </a>
        </div>
        <div className="mx-auto">
          <ul class="footer d-flex list-unstyled text-white">
            <li>Home</li>
            <li>Services</li>
            <li>Projects</li>
            <li>Contact</li>
