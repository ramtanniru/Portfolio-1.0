...
import prj3 from '../assets/images/mern.svg';
import prj4 from '../assets/images/prj-3.png';
...
const H4 = () => {
  ...
  const c3 = [prj3,"Jobify, Web App","Job searching platform",
  "Lorem Ipsum Is Simply Dummy Text Of The Printing And Typesetting Industry.","https://jobify-frontend-khaki.vercel.app/"];
  return (
    <div className='col-10 d-flex flex-column mx-auto' id='h4'>
